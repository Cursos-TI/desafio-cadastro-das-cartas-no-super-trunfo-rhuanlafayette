...
int main() {
    ...
    // Exiba os valores inseridos para cada atributo da cidade, um por linha.
        ...
        printf("Dessa vez, escolha a area de cada cidade respectivamente (coloque .00) \n");
        scanf("%f", &area1A);
        scanf("%f", &area2A);
        scanf("%f", &area3A);
        scanf("%f", &area4A);

        printf("Informe qual sera o PIB de cada cidade respectivamente (lembre de colocar .00)\n");
        scanf("%f", &PIB1A);
        scanf("%f", &PIB2A);
        scanf("%f", &PIB3A);
        scanf("%f", &PIB4A);
